...
const dataConfig = {
  ...
  qnaMessage: {
    ...
    what: {
      ...
      answer: `누구나 책을 고르며 막막한 순간을 경험합니다.\n*\n
      '내가 찾는 내용이 이 책에 있을까?'\n
      '유명한 책이긴 한데... 정말로 재미가 있을까?'\n
      '다들 고전이라고 하니까 나도 읽어야 되는 걸까?'\n
      '베스트셀러지만 내 취향에는 맞지 않는 것 같은데...'\n*\n
      리테라는 매월 당신에게 꼭 맞는 한 권의 책을 선정해 보내드립니다. 당신이 읽고 싶었고 읽어야 할 바로 그 책을, 당신이 왜 그 책을 읽어야 하는지에 대한 이유와 함께.`,
    },
    recommandation: {
      id: 'recomandation',
